      ...
      <div style={{ position: "relative", width: "100%", minHeight: 300 }}>
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(135deg,rgba(0,80,112,0.82),rgba(33,128,168,0.80))",
          }}
        />
        <div
          style={{
          ...
          >
            ...
            <div style={{ maxWidth: 280 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                ...
                />
                <span style={{ fontSize: 22, fontWeight: 700, color: "#fff" }}>TalentYug</span>
              </div>
            ...
            {[
              ...
              <div key={col.heading}>
                <h4 style={{ fontSize: 14, fontWeight: 700, marginBottom: 16, textTransform: "uppercase", letterSpacing: "0.05em", color: "rgba(255,255,255,0.5)" }}>
                  {col.heading}
                </h4>
