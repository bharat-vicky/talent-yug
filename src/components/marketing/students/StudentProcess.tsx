...
const STEPS = [
  {
    n: "step1",
    icon: "/student-img/students/step1_s.png",
    title: "Sign Up",
    desc: "Student registers with email/college — Completes profile — Full name, email, phone — College, batch year, CGPA — Skills & certifications — Location preferences — Salary expectations",
    bg: "#f66d88",
    label: "#BB4D4D",
    pos: { top: 34, left: 0 },
  },
  {
    n: "step2",
    icon: "/student-img/students/step2_s.png",
    title: "Browse Opportunities",
    desc: "View job listings from 50+ companies — Filter by role, salary, location, skills — See job details + company info — Apply with 1-click (auto-filled profile)",
    bg: "#FFBABA",
    label: "#902F2F",
    pos: { top: 35, right: 0 },
  },
  {
    n: "step3",
    icon: "/student-img/students/step3_s.png",
    title: "Prepare for Interview",
    desc: "Access mock interview platform — Practice with role-specific questions — Get AI-generated feedback — Access interview tips and resources",
    bg: "#f66d88",
    label: "#BB4D4D",
    pos: { top: 240, left: "35%" },
  },
  {
    n: "step4",
    icon: "/student-img/students/step4_s.png",
    title: "Interview",
    desc: "Receive interview notification — Interview link provided (video call integration) — Interview conducted with company — Feedback visible after",
    bg: "#FFBABA",
    label: "#902F2F",
    pos: { top: 470, left: 0 },
  },
  {
    n: "step5",
    icon: "/student-img/students/step5_s.png",
    title: "Get Offer",
    desc: "Receive offer via platform — Accept/reject offer — View offer details (role, salary, joining date, benefits) — Download offer letter",
    bg: "#f66d88",
    label: "#BB4D4D",
    pos: { top: 470, right: 0 },
  },
  {
    n: "step6",
    icon: "/student-img/students/step6_s.png",
    title: "Track Progress",
    desc: "Application status tracker — Interview feedback review — Accepted offer details — Post-hire onboarding support",
    bg: "#FFBABA",
    label: "#902F2F",
    pos: { top: 690, left: "35%" },
  },
      ...
      >
        ...
        >
          ...
          <circle
            ...
            r={9}
            fill="#F31642"
            style={{ filter: "drop-shadow(0 0 6px rgba(243,22,66,0.8))" }}
          />
        </svg>
      </section>
    </>
