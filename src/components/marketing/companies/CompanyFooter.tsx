...
export default function CompanyFooter() {
  return (
    <>
      ...
      {/* Footer content */}
      <section style={{ backgroundColor: "#56D1BF", overflow: "hidden" }}>
        <div
          style={{
            maxWidth: 800,
            margin: "auto",
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: 18, color: "#333", margin: 0 }}>
                Call{" "}
                <a href="tel:+918210597576" style={{ color: "#006F5F" }}>
                  +91 8210597576
                </a>
              </p>
              <p style={{ fontSize: 18, color: "#333", margin: 0 }}>
          ...
          <div style={{ textAlign: "center", fontSize: 18, paddingTop: 10 }}>
            Copyright 2026-27 | All Rights Reserved | Privacy Policy | Terms Of
            Service
          </div>
        </div>
      </section>
