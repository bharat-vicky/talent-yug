    ...
    <>
      ...
      >
        <div style={{ lineHeight: 0 }}>
          <Image
            src="/company-img/companies/footer.webp"
      ...
      {/* Footer content */}
      <section style={{ backgroundColor: "#E4FBF8", overflow: "hidden" }}>
        <div
          style={{
            maxWidth: 800,
            margin: "auto",
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <Link href="https://www.facebook.com" target="_blank" rel="noopener" style={{ fontSize: 18, color: "#006F5F", textDecoration: "none" }}>Facebook</Link>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <Link href="#footer" style={{ fontSize: 18, color: "#006F5F", textDecoration: "none" }}>About Us</Link>
            </div>
